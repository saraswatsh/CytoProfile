...
[![R-CMD-check.yaml](https://github.com/saraswatsh/CytoProfile/actions/workflows/R-CMD-check.yaml/badge.svg?branch=devel)](https://github.com/saraswatsh/CytoProfile/actions/workflows/R-CMD-check.yaml)
[![CRAN
...
[![Last
Commit](https://img.shields.io/github/last-commit/saraswatsh/CytoProfile/devel)](https://github.com/saraswatsh/CytoProfile/commits/devel/)
<!-- badges: end -->
...
website](https://cytoprofile.cytokineprofile.org/dev/).
