...
knitr::opts_chunk$set(
  ...
  comment = "#>",
  out.width = "100%",
  fig.keep = "none",  # Discards all plots generated in the chunk
  fig.show = "hide"  # Hides plot output in the rendered document
)
```
...
Below are examples of using the functions provided in CytoProfile. Any saved files that are PDF or PNG format will be found at in the [Output Folder](https://github.com/saraswatsh/CytoProfile/tree/main/output). Additional figures generated will be displayed within the file and can be accessed through the [figures](https://github.com/saraswatsh/CytoProfile/tree/main/man/figures) folder. 
