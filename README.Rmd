...
```{r, Multivariate1, echo=TRUE, warning=FALSE, message=FALSE, fig.show = "hold", out.width = "50%", fig.ncol = 2, cache=TRUE}
# cyt_plsda function.
...
```{r, Multivariate2, echo=TRUE, warning=FALSE, message=FALSE, cache=TRUE, fig.show = "hold", out.width = "50%", fig.ncol = 2, cache=TRUE}
...
```{r, Multivariate3, echo=TRUE, warning=FALSE, message=FALSE, fig.show = "hold", out.width = "50%", fig.ncol = 2, cache=TRUE}
