...
- [`cyt_mint_splsda()`](https://cytoprofile.cytokineprofile.org/dev/reference/cyt_mint_splsda.md)
...
- [`ExampleData1`](https://cytoprofile.cytokineprofile.org/dev/reference/ExampleData1.md)
  : Example Cytokine Profiling Data 1.
- [`ExampleData2`](https://cytoprofile.cytokineprofile.org/dev/reference/ExampleData2.md)
  : Example Cytokine Profiling Data 2.
- [`ExampleData3`](https://cytoprofile.cytokineprofile.org/dev/reference/ExampleData3.md)
  : Example Cytokine Profiling Data 3.
- [`ExampleData4`](https://cytoprofile.cytokineprofile.org/dev/reference/ExampleData4.md)
  : Example Cytokine Profiling Data 4.
- [`ExampleData5`](https://cytoprofile.cytokineprofile.org/dev/reference/ExampleData5.md)
